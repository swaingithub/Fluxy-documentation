...
<div className="flex flex-wrap justify-center gap-8 my-8 p-8 bg-gray-50/50 dark:bg-zinc-900/50 rounded-3xl border border-gray-200 dark:border-zinc-800/50">
  ...
  <img src="/ecommerce-screenshots/screenshot-24.png" alt="Cart Drawer Dark" className="rounded-[2.5rem] border-[8px] border-gray-900 dark:border-zinc-800 shadow-2xl hover:shadow-cyan-500/20 hover:-translate-y-2 transition-all duration-500 w-[280px] h-auto object-cover" />
