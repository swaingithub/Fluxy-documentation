...
description: A collection of Fluxy examples and recipes updated for the Platform Era.
---

# Examples & Recipes

Explore how to build modern apps using the Fluxy Platform feature set.
