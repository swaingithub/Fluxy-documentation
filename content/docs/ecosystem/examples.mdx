...
description: A collection of Fluxy examples and recipes updated for the Platform Era (v0.2.5).
---

# Examples & Recipes

Explore how to build modern apps using the Fluxy v0.2.5 feature set.
