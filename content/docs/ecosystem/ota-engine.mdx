...
In **v0.2.5**, the OTA engine provides critical production safety. You can remotely disable specific platform modules via the manifest `disabled_plugins` array to instantly neutralize production crashes without waiting for a store update.
