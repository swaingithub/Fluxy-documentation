...
Fluxy is composed of two main parts: the **CLI** for orchestration and the **Framework** for building. With the **Platform Era**, Fluxy transitions to a module-based platform architecture.
