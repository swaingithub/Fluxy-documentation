---
title: Installation
description: Learn how to set up Fluxy v1.2.0 with industrial architecture in your Flutter project.
---

# Installation

Fluxy v1.2.0 introduces a revolutionary industrial architecture and Stability Kernel. Install only the packages you need for your specific use case.
...
### Industrial Packages (v1.2.0)

With v1.2.0, Fluxy continues its industrial evolution. Add only the packages you need:
...
dependencies:
  ...
  fluxy_notifications: ^1.2.0 # Push notifications
  fluxy_storage: ^1.2.0      # Data persistence
  fluxy_websocket: ^1.2.0    # Real-time WebSocket
```

### Migration from v1.1.0

If you're upgrading to v1.2.0, check the migration guide for breaking changes and new features:

**[Read Migration Guide](/docs/migration/migration-1-2-0)**
