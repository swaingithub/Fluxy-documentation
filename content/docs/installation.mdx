---
title: Installation
description: Learn how to set up Fluxy v1.1.0 with modular architecture in your Flutter project.
---

# Installation

Fluxy v1.1.0 introduces a revolutionary modular architecture and Stability Kernel. Install only the packages you need for your specific use case.
...
### Modular Packages (v1.1.0)

With v1.1.0, Fluxy continues its modular evolution. Add only the packages you need:
...
dependencies:
  ...
  fluxy_notifications: ^1.1.0 # Push notifications
  fluxy_storage: ^1.1.0      # Data persistence
  fluxy_websocket: ^1.1.0    # Real-time WebSocket
```

### Migration from v1.0.1 or v1.0.0

If you're upgrading to v1.1.0, check the migration guide for breaking changes and new features:

**[Read Migration Guide](/docs/migration/migration-1-1-0)**
