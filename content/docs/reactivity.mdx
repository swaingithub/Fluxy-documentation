...
Fluxy v0.1.2 provides native two-way binding for interactive components. Instead of manually handling `onChanged` and `controller.text`, you can bind a signal directly.
